...
class _AboutUsPageState extends State<AboutUsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // ),
      body: Container(
        decoration: BoxDecoration(image: DecorationImage(image: AssetImage("assets/about_us_back.png"),fit: BoxFit.cover)),
        child: ListView(
            ...
            Container(
              ...
              child: Stack(
                children: [
                  ...
                  Center(child: Text(locale.aboutUs, style: Theme.of(context).textTheme.headline6.copyWith(color: kRoundButtonInButton, fontSize: 18),)),
                ],
              ),
            ),
            Image.asset('assets/clipart_restaurant.png', scale: 1.2, height: 280),
            // Text((title!=null)?'${title}':'',style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16,color: Colors.grey[400]),),
            SizedBox(height: 20),
