...
class _PaymentModePageState extends State<PaymentModePage> {
  ...
  void getPaymentList() async {
    ...
    http.get(paymentGatewaysUri).then((value) {
      print('getPaymentList payment mode => ppy : ${value.body}');
      ...
      print('getPaymentList payment mode  ERROR : ${e.toString()}');
      setState(() {
        isLoading = false;
      });
    });
  ...
  void getWalletAmount() async {
    ...
    http.post(url, body: {'user_id': '${pref.getInt('user_id')}'}).then(
        (value) {
          print('getWalletAmount payment mode  => ppy : ${value.body}');
      if (value.statusCode == 200) {
        // amount
      ...
      print('getWalletAmount payment mode  ERROR : ${e.toString()}');
    });
  }
                                ...
                                children: [
                                  ...
                                  Visibility(
                                    ...
                                    child: buildPaymentType(
                                      ...
                                      //     clientToken:
                                      //         'sandbox_cs4kscwz_m58fswf9gdk2vktw',
                                      //     collectDeviceData: true,
                                      //     paypalRequest: BraintreePayPalRequest(
                                      //       amount:
                                      //           '${double.parse('${makeOrderData.rem_price}')}',
                                      //       displayName: 'Grocery shoping',
                                      //     ),
                                      //   );
                                      ...
                                      //     print(
                                      //         'Nonce: ${result.paymentMethodNonce.description}');
                                      //     print(
                                      //         'Nonce: ${result.paymentMethodNonce.description}');
                                      ...
                                      if (!isLoading) {
                                        ...
                                        Navigator.of(context)
                                          ...
                                          if (value != null) {
                                            ...
                                            Toast.show(
                                                locale.paymentCanceled, context,
                                                gravity: Toast.CENTER,
                                                duration: Toast.LENGTH_SHORT);
                                            setState(() {
                                              isLoading = false;
                                          ...
                                          Toast.show(locale.paymentCanceled, context,
                                              gravity: Toast.CENTER,
                                              duration: Toast.LENGTH_SHORT);
                                          setState(() {
                                            isLoading = false;
                                  ...
                                  Visibility(
                                    ...
                                    child: buildPaymentType(
                                      ...
                                      if (!isLoading) {
                                        Toast.show(locale.comingSoon, context,
                                            gravity: Toast.CENTER,
                                            duration: Toast.LENGTH_SHORT);
                                      }
                                    }),
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            CircleAvatar(
                backgroundColor: kRoundButtonInButton2, radius: 20, child: icon),
            SizedBox(
              width: 20,
            ),
            Text(
              name,
              style: TextStyle(fontWeight: FontWeight.w700,color: kTextBlack, fontSize: 18),
            )
          ],
        ),
      ),
  ...
  void checkOut(String paymentMethod, String paymentStatus, String wallet,
    ...
    var locale = AppLocalizations.of(context);
    var http = Client();
    print('$checkoutUri'+' cart_id : ${makeOrderData.cart_id}' +
