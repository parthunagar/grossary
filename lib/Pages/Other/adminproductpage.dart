...
class MyAdminProductState extends State<MyAdminProduct> {
  ...
  void getAllAdminProductInfo() async {
    ...
    print('getAllAdminProductInfo => storeProductsAdminUri : $storeProductsAdminUri store_id : $id');
    http.post(storeProductsAdminUri, body: {'store_id': '${prefs.getInt('store_id')}'}).then((value) {
      print('getAllAdminProductInfo => value.body : ${value.body.toString()}');
      ...
      print('getAllAdminProductInfo => ERROR : $e');
      setState(() {
        isLoading = false;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      : Align(alignment: Alignment.center, child: Text(locale.itempagenomore)));
  }
