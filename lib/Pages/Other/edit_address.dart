      ...
      if (isLocationServiceEnableds) {
        ...
        await Geolocator.openLocationSettings().then((value) {
          if (value) {
            ...
            Toast.show(locale.locationPermission, context,
            ...
            Column(
              ...
              children: [
                AppBar(
                  title: Text(
                    locale.addAddress,
                    style: TextStyle(fontSize: 18, color: kMainHomeText),
                  ),
                  centerTitle: true,
                  leading: Container(
                              ...
                              Align(
                                ...
                                child:Container(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Image(image:AssetImage('assets/close_icon.png'),
                                      height: 30,width: 30,),
                                  ),
                                ),
                              ),
                                      ...
                                      if (!isSavingAddress) {
                                        if(receiverNameC.text.toString().length !=0 &&receiverNameC.text.toString()!= null && receiverNameC.text.toString()!=''&&!isAllSpaces(receiverNameC.text)){
                                          if(receiverPhoneC.text.toString().length== 10&&phoneValidator(receiverPhoneC.text)){
                                            if(cityData != null){
                                              if(socityData!=null){
                                                if(pincodeC.text.toString().length == 6 && pinCodeValidator(pincodeC.text)){
                                                  if(houseNumberC.text.toString().length!=0 && houseNumberC.text.toString().length < 7){
                                                    if(stateC.text.toString()!=null && stateC.text.toString()!=''&&!isAllSpaces(stateC.text)){
                                                      if(addressLine1C.text.toString()!=null && addressLine1C.text.toString()!=''&&!isAllSpaces(addressLine1C.text)){
                                                        ...
                                                        Toast.show(locale.enterAddress1, context,
                                                      ...
                                                      Toast.show(locale.enterState, context,
                                                          gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                                    }
                                                  }else{
                                                    setState(() {
                                                    ...
                                                    Toast.show(locale.enterHouse, context,
                                                        gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                                  }
                                                }else{
                                                  setState(() {
                                                  ...
                                                  Toast.show(locale.enterPincode,context,
                                                      gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                                }
                                              }else{
                                                setState(() {
                                            ...
                                            Toast.show(locale.enterContact, context,
                                                gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                          }
                                        }else{
                                          setState(() {
                                          ...
                                          Toast.show(locale.enterName, context,
                                              gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                        }
                                        // if(receiverNameC.text.toString().length !=0 &&receiverNameC.text.toString()!= null && receiverNameC.text.toString()!=''){
                                        //   if(receiverPhoneC.text.toString().length== 10){
                                        //     if(cityData != null){
                                        //       if(socityData!=null){
                                        //         if(pincodeC.text.toString().length == 6){
                                        //           if(houseNumberC.text.toString().length!=0 && houseNumberC.text.toString().length < 7){
                                        //             if(stateC.text.toString()!=null && stateC.text.toString()!=''){
                                        //               if(addressLine1C.text.toString()!=null && addressLine1C.text.toString()!=''){
                                        //                 setState(() {
                                        //                   isSavingAddress = true;
                                        //                 });
                                        //                 addAddress(addressd.address_id,context);
                                        ...
                                        //                   isSavingAddress = false;
                                        //                 });
                                        //                 Toast.show('Please address in line 1', context,
                                        //                     gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                        //               }
                                        //             }else{
                                        //               setState(() {
                                        //                 isSavingAddress = false;
                                        //               });
                                        //               Toast.show('Please enter state name', context,
                                        //                   gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                        //             }
                                        //           }else{
                                        //             setState(() {
                                        //               isSavingAddress = false;
                                        //             });
                                        //             Toast.show('Please enter house/flat number', context,
                                        //                 gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                        //           }
                                        //         }else{
                                        //           setState(() {
                                        //             isSavingAddress = false;
                                        //           });
                                        //           Toast.show('Please enter valid pincode', context,
                                        //               gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                        //         }
                                        //       }else{
                                        //         setState(() {
                                        ...
                                        //       isSavingAddress = false;
                                        //     });
                                        //     Toast.show('Please enter valid contact number', context,
                                        //         gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                        //   }
                                        // }else{
                                        //   setState(() {
                                        //     isSavingAddress = false;
                                        //   });
                                        //   Toast.show('Please enter receiver\'s name', context,
                                        //       gravity: Toast.CENTER, duration: Toast.LENGTH_SHORT);
                                        // }
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(color: kHintColor,fontSize: 16,fontWeight: FontWeight.normal),
          ),
          // initialValue: '131001',
        ),
        SizedBox(
