              ...
              Padding(
                ...
                child: RichText(
                  text: TextSpan(children: <TextSpan>[
                    TextSpan(text: locale.balanceAvailable + '\n', style: Theme.of(context).textTheme.subtitle2),
                    TextSpan(text: '\$2300.00', style: Theme.of(context).textTheme.subtitle1.copyWith(height: 1.6, fontSize: 20)),
                ])),
              ),
              Divider(height: 30, thickness: 8, color: Colors.grey[100]),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 18.0, vertical: 12),
                child: Text(locale.provideBankDetails, style: Theme.of(context).textTheme.subtitle2.copyWith(fontWeight: FontWeight.w500)),
              ),
              EntryField(
