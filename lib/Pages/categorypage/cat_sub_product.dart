...
class _CategorySubProductState extends State<CategorySubProduct> {
  ...
  void getCategory(dynamic catid, dynamic storeid) async{
    ...
    http.post(catProductUri,body: {
      ...
      print( 'catProductUri : ${value.body}');
      if(value.statusCode == 200){
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return buildCategoryRow(
                        ...
                        colors1[(index % 4)],
                        colors2[(index % 4)],
                        dataModel.subcategory[index], storedetail,(id){
                      setState(() {
                        isLoading = true;
                      });
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: (isLoading)?buildGridShView()
                    :buildGridView(context,products,wishModel,'$apCurrency',storedetail, callback: (){
...
GridView buildGridView(BuildContext context,List<ProductDataModel> listName, List<WishListDataModel> wishModel,String apCurrency,StoreFinderData storedetail,{bool favourites = false, Function callback}) {
          ...
          children: [
            Container(
              padding: EdgeInsets.only(left: 10),
                child: Text('${product.productName}', maxLines: 1,style: TextStyle(fontWeight: FontWeight.w500, color: kTextBlack))),
            Container(
                padding: EdgeInsets.only(left: 10),
