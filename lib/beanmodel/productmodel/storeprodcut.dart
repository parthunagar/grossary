...
class StoreProductData {
  dynamic productId,catId,productName,productImage,hide,addedBy,approved;
  List<Tags> tags;
  List<Varients> varients;

  StoreProductData({
    this.productId, this.catId, this.productName,
    this.productImage, this.hide, this.addedBy,
    this.approved, this.tags, this.varients});
...
class Varients {
  dynamic addedBy,varientId,description,price,mrp,varientImage;
  dynamic unit,quantity,dealPrice,validFrom,validTo,ean;

  Varients({
    this.addedBy, this.varientId, this.description, this.price, this.mrp, this.varientImage,
    this.unit, this.quantity, this.dealPrice, this.validFrom, this.validTo, this.ean});
