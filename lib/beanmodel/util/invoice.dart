class Invoice {
  dynamic status,message,invoiceNo,number;
  dynamic name,address,city,pincode,paidByWallet,couponDiscount,priceToPay;
  dynamic totalPrice,priceWithoutDelivery,deliveryCharge;
  List<OrderDetails> orderDetails;

  Invoice({
    this.status, this.message, this.invoiceNo, this.number, this.name, this.address, this.city,
    this.pincode, this.paidByWallet, this.couponDiscount, this.priceToPay, this.totalPrice,
    this.priceWithoutDelivery, this.deliveryCharge, this.orderDetails});
...
class OrderDetails {
  dynamic storeOrderId,productName,varientImage,quantity;
  dynamic unit,varientId,qty,price,totalMrp;
  dynamic orderCartId,orderDate,storeApproval,storeId,description;

  OrderDetails({
    this.storeOrderId, this.productName, this.varientImage, this.quantity, this.unit,
    this.varientId, this.qty, this.price, this.totalMrp, this.orderCartId, this.orderDate,
    this.storeApproval, this.storeId, this.description});
