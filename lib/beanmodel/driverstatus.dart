class DriverStatus {
  dynamic status,message,onlineStatus,totalOrders,totalIncentive,receivedIncentive;
  dynamic remainingIncentive,pendingOrders,completedOrders;

  DriverStatus({
    this.status, this.message, this.onlineStatus, this.totalOrders, this.totalIncentive,
    this.receivedIncentive, this.remainingIncentive, this.pendingOrders, this.completedOrders});
