...
class SearchPVarients {
  dynamic storeId,stock,varientId,description;
  dynamic price,mrp,varientImage,unit;
  dynamic quantity,dealPrice,validFrom,validTo;

  SearchPVarients(
      this.storeId, this.stock, this.varientId, this.description,
      this.price, this.mrp, this.varientImage, this.unit,
      this.quantity, this.dealPrice, this.validFrom, this.validTo);
