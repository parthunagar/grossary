class OrderHistoryCompleted {
  dynamic userAddress,orderStatus,storeName,storeLat,storeLng,storeAddress,userLat,userLng;
  dynamic dboyLat,dboyLng,cartId,userName,userPhone,remainingPrice,deliveryBoyName,deliveryBoyPhone;
  dynamic deliveryDate,timeSlot,orderDetails;

  OrderHistoryCompleted(
      {this.userAddress, this.orderStatus,
        this.storeName, this.storeLat, this.storeLng, this.storeAddress, this.userLat, this.userLng,
        this.dboyLat, this.dboyLng, this.cartId, this.userName, this.userPhone, this.remainingPrice,
        this.deliveryBoyName, this.deliveryBoyPhone, this.deliveryDate, this.timeSlot, this.orderDetails});
