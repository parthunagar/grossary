...
class CompletedHistory {
  ...
  CompletedHistory.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = new List<CompletedHistoryOrder>();
      json['data'].forEach((v) {
...
class CompletedHistoryOrder {
  String orderStatus,deliveryDate,timeSlot,paymentMethod,paymentStatus,cartId;
  int paidByWallet,price,delCharge,remainingAmount,couponDiscount;
  String dboyName,dboyPhone,userName;
  List<CHOrderItme> data;

  CompletedHistoryOrder({
    this.orderStatus, this.deliveryDate, this.timeSlot, this.paymentMethod, this.paymentStatus,
    this.paidByWallet, this.cartId, this.price, this.delCharge, this.remainingAmount,
    this.couponDiscount, this.dboyName, this.dboyPhone, this.userName, this.data});
...
class CHOrderItme {
  int storeOrderId;
  String productName,varientImage,orderCartId,orderDate,unit,description;
  int quantity,varientId,qty,price,totalMrp,storeApproval,storeId;

  CHOrderItme({
    this.storeOrderId, this.productName, this.varientImage, this.quantity,
    this.unit, this.varientId, this.qty, this.price, this.totalMrp, this.orderCartId,
