...
class TopSellingRevenueOrdCount {
  dynamic status,message,totalOrders,totalRevenue,pendingOrders;
  List<TopSellingItemsR> data;
...
class TopSellingItemsR {
  dynamic storeId,productName,varientId,varientImage,quantity,unit,description,count,totalqty,revenue;

  TopSellingItemsR({
    this.storeId, this.productName, this.varientId, this.varientImage, this.quantity, this.unit,
    this.description, this.count, this.totalqty, this.revenue});
