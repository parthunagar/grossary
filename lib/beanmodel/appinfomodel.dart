class AppInfoModel{
  ...
  AppInfoModel(
      this.status, this.message, this.app_name, this.app_logo, this.firebase,
      this.country_code, this.firebase_iso, this.sms, this.phone_number_length,
      this.currency_sign,this.refertext,this.last_loc);
