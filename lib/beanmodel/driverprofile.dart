class DriverProfilePeople {
  dynamic status,message,totalIncentive,receivedIncentive,remainingIncentive,bankDetails;
  DriverData driverData;

  DriverProfilePeople({
    this.status, this.message, this.totalIncentive, this.receivedIncentive,
    this.remainingIncentive, this.driverData, this.bankDetails});
...
class DriverData {
  dynamic dboyId,boyName,boyPhone,boyCity,password,deviceId;
  dynamic boyLoc,lat,lng,status,storeId,storeDboyId,addedBy;

  DriverData({
    this.dboyId, this.boyName, this.boyPhone,
    this.boyCity, this.password, this.deviceId, this.boyLoc, this.lat,
    this.lng, this.status, this.storeId, this.storeDboyId, this.addedBy});
