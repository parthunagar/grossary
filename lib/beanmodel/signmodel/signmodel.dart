...
class SignDataModel{
  ...
  dynamic store_id,store_name,employee_name,phone_number;
  dynamic store_photo,city,admin_share,device_id,email,password;
  dynamic del_range,lat,lng,address,admin_approval,store_status;
  dynamic store_opening_time,store_closing_time,time_interval,inactive_reason;

  SignDataModel(
      this.store_id, this.store_name, this.employee_name, this.phone_number, this.store_photo,
      this.city, this.admin_share, this.device_id, this.email, this.password, this.del_range,
      this.lat, this.lng, this.address, this.admin_approval, this.store_status, this.store_opening_time,
      this.store_closing_time, this.time_interval, this.inactive_reason);

  factory SignDataModel.fromJson(dynamic json){
    return SignDataModel(json['store_id'], json['store_name'], json['employee_name'], json['phone_number'], json['store_photo'], json['city'], json['admin_share'], json['device_id'], json['email'], json['password'], json['del_range'], json['lat'], json['lng'], json['address'], json['admin_approval'], json['store_status'], json['store_opening_time'], json['store_closing_time'], json['time_interval'], json['inactive_reason']);
  }
